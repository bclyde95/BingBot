...
class TweetTerms:
    ...
    def getHomeTweets(self):
        """Gets 15 tweets from users homepage, removes all special characters, splits every two words, and returns a jagged list of two-word terms"""
        terms = []
        for t in tweepy.Cursor(self.api.home_timeline).items(15):
